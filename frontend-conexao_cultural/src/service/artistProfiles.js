const ARTIST_PROFILES = [
  ...
  {
    id: 'artist_oracle_1',
    ownerUserId: 'u_artist_seed_3',
    name: 'O Bardo Misterioso',
    handle: '@bardo_misterioso',
    vibe: 'Acústico / Folk',
    entity: 'Bardo Solitário',
    bio: 'Canções íntimas para noites de ritual e sala cheia.',
    avatarUrl: '',
    avatarFallbackStyle: 'sigil',
    techRider: '1 mic para voz, 1 cabo P10 para violão acústico.',
    communityTitle: 'Oeste Sombrio',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'artist_oracle_2',
    ownerUserId: 'u_artist_seed_4',
    name: 'Lira de Aço',
    handle: '@lira_aco',
    vibe: 'Rock / Alternativo',
    entity: 'A Guilda (Banda)',
    bio: 'Energia de palco e presença de arena para o seu local.',
    avatarUrl: '',
    avatarFallbackStyle: 'neon',
    techRider: 'Bateria completa, 2 amps de guitarra valvulados, 1 baixo, 3 vocais.',
    communityTitle: 'Legião de Aço',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'artist_oracle_3',
    ownerUserId: 'u_artist_seed_5',
    name: 'Coro da Madrugada',
    handle: '@coro_madrugada',
    vibe: 'MPB / Atmosférico',
    entity: 'Coletivo Vocal',
    bio: 'Texturas elegantes para rituais mais sofisticados.',
    avatarUrl: '',
    avatarFallbackStyle: 'minimal',
    techRider: '4 microfones condensadores, piano digital em estéreo.',
    communityTitle: 'Seresteiros da Madrugada',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'artist_lady',
    ownerUserId: 'u_artist_seed_6',
    name: 'Lady Sombria',
    handle: '@lady_dark',
    vibe: 'Jazz Noir',
    entity: 'Artista Solo',
    bio: 'Voz aveludada, trompete com surdina e canções para madrugadas chuvosas.',
    avatarUrl: '',
    avatarFallbackStyle: 'neon',
    techRider: 'Microfone vintage estilo Shure 55SH, pedestal de base redonda.',
    communityTitle: 'Sombra & Melancolia',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'artist_baronesa',
    ownerUserId: 'u_artist_seed_7',
    name: 'Baronesa do Neón',
    handle: '@baronesa_neon',
    vibe: 'Synthpop / Retrô',
    entity: 'Projeto Solo',
    bio: 'Batidas oitentistas, refrãos chiclete e iluminação de néon pulsante.',
    avatarUrl: '',
    avatarFallbackStyle: 'sigil',
    techRider: 'Mesa controladora MIDI, interface de áudio, 2 saídas L/R.',
    communityTitle: 'Corte do Neón',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'artist_dama',
    ownerUserId: 'u_artist_seed_8',
    name: 'Dama do Palco',
    handle: '@dama_palco',
    vibe: 'Blues / Soul',
    entity: 'Artista Solo',
    bio: 'Interpretações viscerais de clássicos do blues e composições sobre a estrada.',
    avatarUrl: '',
    avatarFallbackStyle: 'neon',
    techRider: '1 canal de voz, 1 amplificador Fender Twin Reverb.',
    communityTitle: 'Irmandade do Blues',
    createdAt: new Date().toISOString(),
  },
  {
    id: 'artist_alquimista',
    ownerUserId: 'u_artist_seed_9',
    name: 'Alquimista dos Synths',
    handle: '@synth_alchemist',
    vibe: 'Ambient / Drone',
    entity: 'Produtor / Performer',
    bio: 'Sintetizadores modulares, cabos infinitos e frequências graves que vibram as paredes.',
    avatarUrl: '',
    avatarFallbackStyle: 'neon',
    techRider: 'Mesa grande para módulos Eurorack, 4 saídas balanceadas, sub-grave dedicado.',
    communityTitle: 'Laboratório Modular',
    createdAt: new Date().toISOString(),
  },
];
